...
function whatsnew.draw(ctx, state, res)
  ...
  -- Submission order alone does not raise an existing native window.
  -- Request focus only on opening, so later clicks can select other panels.
  if ui.focus_pending then
